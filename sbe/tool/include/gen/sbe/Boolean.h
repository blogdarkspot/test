...
#ifndef _SBE_BOOLEAN_H_
#define _SBE_BOOLEAN_H_
...
public:
    enum Value
    {
        TRUE = static_cast<char>(89),
        FALSE = static_cast<char>(78),
        NULL_VALUE = static_cast<char>(0)
    };

    static Boolean::Value get(const char value)
    {
        switch (value)
        {
            case static_cast<char>(89): return TRUE;
            case static_cast<char>(78): return FALSE;
